                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                                        <div className="space-y-1.5">
                                            <div className="flex flex-wrap items-center gap-2.5">
                                                ...
                                                {study.status === 'completed' && (
                                                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-mono font-medium bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 shadow-xs">
                                                        <Check className="w-3 h-3 stroke-[2.5]" />
                                                        Completed
                                                    </span>
                                                )}
                                                {study.status === 'in-progress' && (
                                                    <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-mono font-medium bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/20 shadow-xs">
                                        ...
                                        {study.grade && (
                                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white dark:bg-zinc-900 border border-black/5 dark:border-white/5 rounded-full shadow-xs shrink-0 self-start sm:self-auto">
                                                <span className="text-[9px] font-mono uppercase tracking-widest text-gray-400">{study.gradeLabel || 'Result'}</span>
