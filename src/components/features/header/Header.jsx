...
const Header = () => {
    ...
    // Google Maps Link for Ahmedabad
    const mapLink = "https://www.google.com/maps/place/Ahmedabad,+Gujarat,+India";
            ...
            <div className="relative -mt-24 px-2 flex flex-col items-start translate-z-10">
                            ...
                            <Tooltip
                                ...
                                content={
                                    <div className="flex items-center gap-3 min-w-[140px]">
                                        ...
                                        <div>
                                            <p className="font-semibold text-white dark:text-zinc-900 text-sm">Ahmedabad, IN</p>
                ...
                <div className="mt-10 w-full max-w-2xl">
                    <h2 className="text-3xl sm:text-4xl font-instrument italic font-normal text-zinc-900 dark:text-white tracking-tight leading-[1.1] mb-8">
                        Building <span className="font-inter not-italic font-bold text-zinc-400 dark:text-zinc-600">Intelligent</span> <br />
                    ...
                    <div className="space-y-6">
                        <div className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 font-inter font-light leading-relaxed tracking-tight">
                            Currently a{" "}
                            <span className="text-zinc-900 dark:text-zinc-200 font-medium whitespace-nowrap">B.Tech CS (Data Science)</span>{" "}
                            student at{" "}
                            <span className="font-instrument italic text-zinc-950 dark:text-white">
                        ...
                        <p className="text-base text-zinc-500 dark:text-zinc-500 font-inter font-light leading-relaxed max-w-xl">
                            Specializing in <span className="text-zinc-800 dark:text-zinc-300 font-medium">full-stack web development</span>, <span className="text-zinc-800 dark:text-zinc-300 font-medium">AI/ML integration</span>, and <span className="text-zinc-800 dark:text-zinc-300 font-medium">data analysis</span>. Passionate about building scalable software and AI-powered tools that solve real-world problems.
                        </p>
                    </div>
                </div>
